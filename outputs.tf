...
output "log_analytics_workspace_tables_plan" {
  ...
  value       = { for k, v in azurerm_log_analytics_workspace_table.log_analytics_workspace_tables : k => v.plan }
}
output "log_analytics_workspace_tables_retention_in_days" {
  ...
  value       = { for k, v in azurerm_log_analytics_workspace_table.log_analytics_workspace_tables : k => v.retention_in_days }
}
output "log_analytics_workspace_tables_total_retention_in_days" {
  ...
  value       = { for k, v in azurerm_log_analytics_workspace_table.log_analytics_workspace_tables : k => v.total_retention_in_days }
}
output "log_analytics_workspace_tables_workspace_id" {
  ...
  value       = { for k, v in azurerm_log_analytics_workspace_table.log_analytics_workspace_tables : k => v.workspace_id }
}
